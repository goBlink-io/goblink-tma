import { H as Qt, c as St, a as pt, t as Jt, b as te, d as ye, e as mt, f as xe, r as G, g as Ee, h as Be, i as ve, j as Se } from "./index-3203c1a5.js";
import "./connector-4bc69b15.js";
import "starknet";
import "./Modal-897c4ec2.js";
import "./trpc-d914d822.js";
import "./lastConnected-c0cae438.js";
import "./index-42161a8d.js";
import "./core-7c9d487b.js";
import "./argentX.js";
...
class Oe extends Qt {
  constructor(e, t, r, i) {
    super(), this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.blockLen = e, this.outputLen = t, this.padOffset = r, this.isLE = i, this.buffer = new Uint8Array(e), this.view = St(this.buffer);
  }
  update(e) {
    pt(this), e = Jt(e), te(e);
  ...
  digestInto(e) {
    pt(this), ye(e, this), this.finished = !0;
    const { buffer: t, view: r, blockLen: i, isLE: s } = this;
    let { pos: c } = this;
    t[c++] = 128, mt(this.buffer.subarray(c)), this.padOffset > i - c && (this.process(r, 0), c = 0);
    for (let h = c; h < i; h++)
      t[h] = 0;
    Ae(r, i - 8, BigInt(this.length * 8), s), this.process(r, 0);
    const f = St(e), o = this.outputLen;
    if (o % 4)
...
class ee extends Qt {
  constructor(e, t) {
    ...
    for (let c = 0; c < s.length; c++)
      s[c] ^= 106;
    this.oHash.update(s), mt(s);
  }
  update(e) {
    return pt(this), this.iHash.update(e), this;
  }
  digestInto(e) {
    pt(this), te(e, this.outputLen), this.finished = !0, this.iHash.digestInto(e), this.oHash.update(e), this.oHash.digestInto(e), this.destroy();
  }
  digest() {
...
const ne = (n, e, t) => new ee(n, e).update(t).digest();
ne.create = (n, e) => new ee(n, e);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const zt = /* @__PURE__ */ BigInt(0), _t = /* @__PURE__ */ BigInt(1);
function ht(n) {
...
function ie(n) {
  return Ct(n), re(dt(Uint8Array.from(n).reverse()));
}
function wt(n, e) {
  return bt(n.toString(16).padStart(e * 2, "0"));
}
function se(n, e) {
...
const At = (n) => typeof n == "bigint" && zt <= n;
function Vt(n, e, t) {
  return At(n) && At(e) && At(t) && e <= n && n < t;
}
function ft(n, e, t, r) {
  if (!Vt(e, t, r))
...
function _e(n) {
  let e;
  for (e = 0; n > zt; n >>= _t, e += 1)
    ;
  return e;
}
const xt = (n) => (_t << BigInt(n)) - _t, It = (n) => new Uint8Array(n), Kt = (n) => Uint8Array.from(n);
function Re(n, e, t) {
  ...
  let r = It(n), i = It(n), s = 0;
  const c = () => {
    r.fill(1), i.fill(0), s = 0;
  }, f = (...h) => t(i, r, ...h), o = (h = It(0)) => {
...
const Te = {
  ...
  stringOrUint8Array: (n) => typeof n == "string" || ht(n),
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const j = BigInt(0), C = BigInt(1), rt = /* @__PURE__ */ BigInt(2), Ze = /* @__PURE__ */ BigInt(3), ce = /* @__PURE__ */ BigInt(4), fe = /* @__PURE__ */ BigInt(5), ae = /* @__PURE__ */ BigInt(8);
function M(n, e) {
  const t = n % e;
  return t >= j ? t : e + t;
}
...
function Ce(n) {
  return n % ce === Ze ? ue : n % ae === fe ? ke : ze(n);
}
const Ve = [
  "create",
  "isValid",
...
function Ye(n, e, t = !1) {
  ...
  const c = t ? ie(n) : ot(n), f = M(c, e - C) + C;
  return t ? se(f, i) : wt(f, i);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function Ot(n, e) {
  ge(n, e);
  const t = Math.ceil(e / n) + 1, r = 2 ** (n - 1), i = 2 ** n, s = xt(n), c = BigInt(n);
...
const qt = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap();
function Ht(n) {
  return pe.get(n) || 1;
}
function De(n, e) {
  return {
    ...
    precomputeWindow(t, r) {
      const { windows: i, windowSize: s } = Ot(r, e), c = [];
      let f = t, o = f;
      for (let l = 0; l < i; l++) {
        o = f, c.push(o);
        for (let g = 1; g < s; g++)
    ...
    wNAF(t, r, i) {
      ...
      for (let o = 0; o < f.windows; o++) {
        ...
        i = l, h ? c = c.add(Nt(q, r[_])) : s = s.add(Nt(B, r[g]));
      }
      return { p: s, f: c };
    },
    /**
...
function Ge(n, e, t, r) {
  ...
  const l = xt(o), g = new Array(Number(l) + 1).fill(c), h = Math.floor((e.BITS - 1) / o) * o;
  let B = c;
  for (let q = h; q >= 0; q -= o) {
    g.fill(c);
    for (let p = 0; p < s; p++) {
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
function $t(n) {
  n.lowS !== void 0 && lt("lowS", n.lowS), n.prehash !== void 0 && lt("prehash", n.prehash);
}
function We(n) {
  const e = me(n);
  Et(e, {
...
const F = {
  ...
  _tlv: {
    encode: (n, e) => {
      ...
      const r = e.length / 2, i = gt(r);
      if (i.length / 2 & 128)
        throw new t("tlv.encode: long form length too big");
      const s = r > 127 ? gt(i.length / 2 | 128) : "";
      return gt(n) + s + i + e;
    },
...
const X = BigInt(0), T = BigInt(1);
BigInt(2);
const Ut = BigInt(3), Fe = BigInt(4);
function Xe(n) {
  const e = We(n), { Fp: t } = e, r = Mt(e.n, e.nBitLength), i = e.toBytes || ((A, a, w) => {
    const b = a.toAffine();
    return yt(Uint8Array.from([4]), t.toBytes(b.x), t.toBytes(b.y));
  }), s = e.fromBytes || ((A) => {
  ...
  const o = t.mul(t.pow(e.a, Ut), Fe), l = t.mul(t.sqr(e.b), BigInt(27));
  if (t.is0(t.add(o, l)))
  ...
  function h(A) {
    ...
    if (a && typeof A != "bigint") {
      if (ht(A) && (A = dt(A)), typeof A != "string" || !a.includes(A.length))
    ...
    return b && (O = M(O, v)), ft("private key", O, T, v), O;
  }
  function B(A) {
    if (!(A instanceof p))
  ...
  class p {
    ...
    double() {
      const { a, b: w } = e, b = t.mul(w, Ut), { px: v, py: O, pz: L } = this;
      let H = t.ZERO, y = t.ZERO, N = t.ZERO, x = t.mul(v, v), Z = t.mul(O, O), d = t.mul(L, L), u = t.mul(v, O);
    ...
    multiplyUnsafe(a) {
      ...
      let { k1neg: O, k1: L, k2neg: H, k2: y } = w.splitScalar(a), N = v, x = v, Z = this;
      for (; L > X || y > X; )
        L & T && (N = N.add(Z)), y & T && (x = x.add(Z)), Z = Z.double(), L >>= T, y >>= T;
    ...
    multiply(a) {
      ...
      if (w) {
        ...
        let { p: x, f: Z } = this.wNAF(H), { p: d, f: u } = this.wNAF(N);
        x = D.constTimeNegate(L, x), d = D.constTimeNegate(y, d), d = new p(t.mul(d.px, w.beta), d.py, d.pz), v = x.add(d), O = Z.add(u);
      } else {
    ...
    multiplyAndAddUnsafe(a, w, b) {
      const v = p.BASE, O = (H, y) => y === X || y === T || !H.equals(v) ? H.multiplyUnsafe(y) : H.multiply(y), L = O(this, w).add(O(a, b));
    ...
    clearCofactor() {
      ...
      return a === T ? this : w ? w(p, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(a = !0) {
      return lt("isCompressed", a), this.assertValidity(), i(p, this, a);
    }
    toHex(a = !0) {
...
function Je(n) {
  ...
  const { ProjectivePoint: g, normPrivateKeyToScalar: h, weierstrassEquation: B, isWithinCurveOrder: q } = Xe({
    ...e,
    toBytes(d, u, m) {
      const I = u.toAffine(), E = t.toBytes(I.x), S = yt;
      return lt("isCompressed", m), m ? S(Uint8Array.from([u.hasEvenY() ? 2 : 3]), E) : S(Uint8Array.from([4]), E, t.toBytes(I.y));
    },
    fromBytes(d) {
  ...
  class R {
    constructor(u, m, I) {
      ft("r", u, T, r), ft("s", m, T, r), this.r = u, this.s = m, I != null && (this.recovery = I), Object.freeze(this);
    }
    ...
    recoverPublicKey(u) {
      ...
      const z = E & 1 ? "03" : "02", W = g.fromHex(z + Lt(U, t.BYTES)), P = l(U), V = o(-S * P), it = o(I * P), Q = g.BASE.multiplyAndAddUnsafe(W, V, it);
      if (!Q)
    ...
    toCompactHex() {
      const u = i;
      return Lt(this.r, u) + Lt(this.s, u);
    }
  }
  const D = {
    isValidPrivateKey(d) {
  ...
  function L(d) {
    return ft("num < 2^" + s, d, X, O), wt(d, i);
  }
  function H(d, u, m = y) {
    ...
    function Bt(et) {
      ...
      if (!q(st))
        return;
      const vt = l(st), at = g.BASE.multiply(st).toAffine(), nt = o(at.x);
      if (nt === X)
        return;
      const ut = o(vt * o(Q + nt * P));
      if (ut === X)
        return;
      let ct = (at.x === nt ? 0 : 2) | Number(at.y & T), jt = ut;
      return S && _(ut) && (jt = p(ut), ct ^= 1), new R(nt, jt, ct);
    }
    return { seed: it, k2sig: Bt };
  }
  ...
  function Z(d, u, m, I = N) {
    ...
    const W = typeof E == "string" || ht(E), P = !W && !z && typeof E == "object" && E !== null && typeof E.r == "bigint" && typeof E.s == "bigint";
    if (!W && !P)
    ...
    if (!V || S && V.hasHighS())
      return !1;
    U && (u = e.hash(u));
    const { r: Q, s: Bt } = V, et = v(u), st = l(Bt), vt = o(et * st), at = o(Q * st), nt = g.BASE.multiplyAndAddUnsafe(it, vt, at)?.toAffine();
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const be = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Ft = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), nn = BigInt(0), rn = BigInt(1), Zt = BigInt(2), Xt = (n, e) => (n + e / Zt) / e;
function on(n) {
  const e = be, t = BigInt(3), r = BigInt(6), i = BigInt(11), s = BigInt(22), c = BigInt(23), f = BigInt(44), o = BigInt(88), l = n * n * n % e, g = l * l * n % e, h = Y(g, t, e) * g % e, B = Y(h, t, e) * g % e, q = Y(B, Zt, e) * l % e, _ = Y(q, i, e) * q % e, p = Y(_, s, e) * _ % e, k = Y(p, f, e) * p % e, R = Y(k, o, e) * k % e, D = Y(R, f, e) * p % e, A = Y(D, t, e) * g % e, a = Y(A, c, e) * _ % e, w = Y(a, r, e) * l % e, b = Y(w, Zt, e);
  if (!kt.eql(kt.sqr(b), n))
    throw new Error("Cannot find square root");
  return b;
}
const kt = Mt(be, void 0, void 0, { sqrt: on }), mn = en({
  a: nn,
  b: BigInt(7),
  Fp: kt,
  n: Ft,
