...
exports.TronLinkEvmAdapter = exports.TronLinkEvmAdapterName = void 0;
const abstract_adapter_evm_1 = require("@tronweb3/abstract-adapter-evm");
const utils_js_1 = require("./utils.js");
exports.TronLinkEvmAdapterName = 'TronLink';
class TronLinkEvmAdapter extends abstract_adapter_evm_1.Adapter {
    constructor() {
        super();
        this.name = exports.TronLinkEvmAdapterName;
        // @prettier-ignore
        ...
        const provider = (0, utils_js_1.getTronLinkEvmProvider)();
        if (provider) {
    ...
    signTypedData(params) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new abstract_adapter_evm_1.WalletError('[TronLinkEvm] The wallet does not support signTypedData() currently.');
        });
    }
    addChain(chainInfo) {
        return __awaiter(this, void 0, void 0, function* () {
            throw new abstract_adapter_evm_1.WalletError('[TronLinkEvm] The wallet does not support addChain() currently.');
        });
    }
    getProvider() {
        return __awaiter(this, void 0, void 0, function* () {
            if ((0, abstract_adapter_evm_1.isInMobileBrowser)()) {
    ...
    autoConnect(provider) {
        return __awaiter(this, void 0, void 0, function* () {
            setTimeout(() => {
                this.address = provider.selectedAddress || null;
                if (this.address) {
...
exports.TronLinkEvmAdapter = TronLinkEvmAdapter;
