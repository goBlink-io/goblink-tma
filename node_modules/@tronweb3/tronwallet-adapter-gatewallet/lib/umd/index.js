(function (global, factory) {
	...
	function requireUtils () {
		...
		utils.isGateApp = void 0;
		utils.supportGateWallet = supportGateWallet;
		utils.isInGateApp = isInGateApp;
		utils.openGateWallet = openGateWallet;
		const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
		function supportGateWallet() {
		    return !!(window.gatewallet && window.gatewallet.tronLink);
		}
		utils.isGateApp = typeof navigator !== 'undefined' && /GateApp/i.test(navigator.userAgent);
		...
		function openGateWallet() {
		    if (!isInGateApp() && (0, tronwallet_abstract_adapter_1.isInMobileBrowser)()) {
