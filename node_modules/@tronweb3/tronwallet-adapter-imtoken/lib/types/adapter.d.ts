...
export declare const ImTokenWalletAdapterName: AdapterName<"imToken Wallet">;
export declare class ImTokenAdapter extends Adapter {
    name: AdapterName<"imToken Wallet">;
    url: string;
    icon: string;
