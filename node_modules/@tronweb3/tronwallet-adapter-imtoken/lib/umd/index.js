(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@tronweb3/tronwallet-adapter-imtoken"] = factory());
	...
	function requireUtils () {
		...
		utils.supportImToken = supportImToken;
		utils.openImTokenApp = openImTokenApp;
		const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
		function supportImToken() {
		    return !!window.imToken && !!window.tronWeb;
		}
		function openImTokenApp() {
		    if ((0, tronwallet_abstract_adapter_1.isInMobileBrowser)() && !supportImToken()) {
		        const { origin, pathname, search, hash } = window.location;
	...
	function requireAdapter () {
		...
		(function (exports) {
			...
			Object.defineProperty(exports, "__esModule", { value: true });
			exports.ImTokenAdapter = exports.ImTokenWalletAdapterName = void 0;
			const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
			const tronwallet_adapter_tronlink_1 = /*@__PURE__*/ requireCjs$1();
			const utils_js_1 = /*@__PURE__*/ requireUtils();
			exports.ImTokenWalletAdapterName = 'imToken Wallet';
			class ImTokenAdapter extends tronwallet_abstract_adapter_1.Adapter {
			    constructor(config = {}) {
			        super();
			        this.name = exports.ImTokenWalletAdapterName;
			        ...
			        this._updateWallet = () => __awaiter(this, void 0, void 0, function* () {
			            ...
			            let state = this.state;
			            let address = this.address;
			            if ((0, utils_js_1.supportImToken)()) {
			                this._wallet = {
			                    ready: ((_a = window.tronWeb) === null || _a === void 0 ? void 0 : _a.ready) || false,
			    ...
			    _checkWallet() {
			        ...
			        this._checkPromise = new Promise((resolve) => {
			            const check = () => {
			                times++;
			                const isSupport = (0, utils_js_1.supportImToken)();
			                if (isSupport || times > maxTimes) {
			                    timer && clearInterval(timer);
			                    this._readyState = isSupport ? tronwallet_abstract_adapter_1.WalletReadyState.Found : tronwallet_abstract_adapter_1.WalletReadyState.NotFound;
			                    this._updateWallet();
			    ...
			    checkIfOpenApp() {
			        ...
			        if ((0, utils_js_1.openImTokenApp)()) {
			            throw new tronwallet_abstract_adapter_1.WalletNotFoundError();
			        }
			    }
			    setAddress(address) {
			...
			exports.ImTokenAdapter = ImTokenAdapter;
