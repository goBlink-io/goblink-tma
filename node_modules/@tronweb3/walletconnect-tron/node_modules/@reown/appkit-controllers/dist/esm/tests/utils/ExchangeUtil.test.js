...
describe('ExchangeUtil', () => {
    ...
    describe('getApiUrl', () => {
        it('returns the correct WalletConnect JSON-RPC URL', () => {
            const url = getApiUrl();
            expect(url).toBe('https://rpc.walletconnect.org/v1/json-rpc?projectId=test-project-id&source=fund-wallet');
        });
    });
    describe('JSON-RPC requests', () => {
        it('getExchanges sends request and returns result', async () => {
            ...
            expect(String(calledUrl)).toBe('https://rpc.walletconnect.org/v1/json-rpc?projectId=test-project-id&source=fund-wallet');
