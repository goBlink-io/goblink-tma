...
import { Adapter, WalletReadyState, WalletNotFoundError, WalletConnectionError, isInMobileBrowser, WalletError, } from '@tronweb3/abstract-adapter-evm';
import { getBinanceEvmProvider, openBinanceWithDeeplink, supportBinanceEvm } from './utils.js';
export const BinanceEvmAdapterName = 'Binance';
export class BinanceEvmAdapter extends Adapter {
    constructor(options = { useDeeplink: true }) {
        super();
        this.name = BinanceEvmAdapterName;
        // @prettier-ignore
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new WalletConnectionError('Connection error: ' + (e === null || e === void 0 ? void 0 : e.message), e);
            }
            if (!accounts.length) {
