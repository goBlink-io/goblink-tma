(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@tronweb3/tronwallet-adapter-bybit"] = factory());
	...
	function requireUtils () {
		...
		utils.isBybitApp = void 0;
		utils.supportBybitWallet = supportBybitWallet;
		utils.isInBybitApp = isInBybitApp;
		utils.openBybitWallet = openBybitWallet;
		const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
		function supportBybitWallet() {
		    return !!(window.bybitWallet && window.bybitWallet.tronLink);
		}
		utils.isBybitApp = typeof navigator !== 'undefined' && /bybit_app/i.test(navigator.userAgent);
	...
	function requireAdapter () {
		...
		(function (exports) {
			...
			Object.defineProperty(exports, "__esModule", { value: true });
			exports.BybitWalletAdapter = exports.BybitWalletAdapterName = void 0;
			const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
			const tronwallet_adapter_tronlink_1 = /*@__PURE__*/ requireCjs$1();
			const utils_js_1 = /*@__PURE__*/ requireUtils();
			exports.BybitWalletAdapterName = 'Bybit Wallet';
			class BybitWalletAdapter extends tronwallet_abstract_adapter_1.Adapter {
			    constructor(config = {}) {
			        super();
			        this.name = exports.BybitWalletAdapterName;
			        ...
			        this._updateWallet = () => {
			            ...
			            let state = this.state;
			            let address = this.address;
			            if ((0, utils_js_1.supportBybitWallet)()) {
			        ...
			        return __awaiter(this, void 0, void 0, function* () {
			            ...
			            try {
			                ...
			                try {
			                    ...
			                    if (res.code === 4000) {
			                        throw new tronwallet_abstract_adapter_1.WalletConnectionError('The same DApp has already initiated a request to connect to BybitWallet, and the pop-up window has not been closed.');
			                    }
			                    if (res.code === 4001) {
			                        throw new tronwallet_abstract_adapter_1.WalletConnectionError('The user rejected connection.');
			                    }
			    ...
			    checkIfOpenBybitWallet() {
			        ...
			        if ((0, utils_js_1.openBybitWallet)()) {
			            throw new tronwallet_abstract_adapter_1.WalletNotFoundError();
			        }
			    }
			    /**
			    ...
			    _checkWallet() {
			        ...
			        this._checkPromise = new Promise((resolve) => {
			            const check = () => {
			                times++;
			                const isSupport = (0, utils_js_1.supportBybitWallet)();
			                if (isSupport || times > maxTimes) {
			                    timer && clearInterval(timer);
			                    this._readyState = isSupport ? tronwallet_abstract_adapter_1.WalletReadyState.Found : tronwallet_abstract_adapter_1.WalletReadyState.NotFound;
			                    this._updateWallet();
			...
			exports.BybitWalletAdapter = BybitWalletAdapter;
