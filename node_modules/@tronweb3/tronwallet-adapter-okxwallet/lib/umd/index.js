(function (global, factory) {
	...
	function requireUtils () {
		...
		utils.isOKApp = void 0;
		utils.supportOkxWallet = supportOkxWallet;
		utils.isInOKApp = isInOKApp;
		utils.openOkxWallet = openOkxWallet;
		const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
		function supportOkxWallet() {
		    return !!(window.okxwallet && window.okxwallet.tronLink);
		}
		utils.isOKApp = typeof navigator !== 'undefined' && /OKApp/i.test(navigator.userAgent);
		function isInOKApp() {
