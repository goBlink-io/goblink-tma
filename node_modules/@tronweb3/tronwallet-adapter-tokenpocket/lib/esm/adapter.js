...
import { Adapter, AdapterState, isInBrowser, WalletReadyState, WalletSignMessageError, WalletNotFoundError, WalletDisconnectedError, WalletSignTransactionError, WalletGetNetworkError, WalletConnectionError, isInMobileBrowser, WalletError, } from '@tronweb3/tronwallet-abstract-adapter';
import { getNetworkInfoByTronWeb } from '@tronweb3/tronwallet-adapter-tronlink';
import { openTokenPocket, supportTokenPocket } from './utils.js';
import { TIP6963AnnounceProviderEventName, TIP6963RequestProviderEventName, } from '@tronweb3/tronwallet-abstract-adapter';
export const TokenPocketAdapterName = 'TokenPocket';
export class TokenPocketAdapter extends Adapter {
            ...
            try {
                ...
                try {
                    ...
                    if (e instanceof WalletError) {
                        ...
                        throw new WalletConnectionError(e === null || e === void 0 ? void 0 : e.message, e);
                    }
                }
            }
            catch (error) {
    ...
    checkForWalletReady() {
        ...
        const check = () => {
            var _a, _b, _c, _d;
            if (isInMobileBrowser() && ((_a = window.tronWeb) === null || _a === void 0 ? void 0 : _a.ready)) {
