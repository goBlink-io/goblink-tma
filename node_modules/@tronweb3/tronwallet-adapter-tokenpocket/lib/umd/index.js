(function (global, factory) {
	...
	function requireTypes$1 () {
		...
		types$1.TIP6963RequestProviderEventName = types$1.TIP6963AnnounceProviderEventName = types$1.ChainNetwork = types$1.NetworkType = void 0;
		var NetworkType;
	...
	function requireAdapter () {
		...
		(function (exports) {
			...
			const tronwallet_abstract_adapter_2 = /*@__PURE__*/ requireCjs$2();
			...
			class TokenPocketAdapter extends tronwallet_abstract_adapter_1.Adapter {
			    constructor(config = {}) {
			        ...
			        this._updateWallet = () => {
			            ...
			            if ((0, utils_js_1.supportTokenPocket)()) {
			                const tron = (_a = window.tokenpocket) === null || _a === void 0 ? void 0 : _a.tron;
			                this._wallet = (0, tronwallet_abstract_adapter_1.isInMobileBrowser)()
			                    ? {
			                        tron,
			        ...
			        this._wallet = null;
			        this._address = null;
			        if ((0, tronwallet_abstract_adapter_1.isInMobileBrowser)() && (0, utils_js_1.supportTokenPocket)()) {
			            this._readyState = tronwallet_abstract_adapter_1.WalletReadyState.Found;
			            this._updateWallet();
			        }
			        else {
			    ...
			    checkForWalletReady() {
			        ...
			        const check = () => {
			            var _a, _b, _c, _d;
			            if ((0, tronwallet_abstract_adapter_1.isInMobileBrowser)() && ((_a = window.tronWeb) === null || _a === void 0 ? void 0 : _a.ready)) {
			                this.checkReadyInterval && clearInterval(this.checkReadyInterval);
			                this.checkReadyInterval = null;
			                this._updateWallet();
			                this.emit('connect', this.address || '');
			                ...
			                const state = address ? tronwallet_abstract_adapter_1.AdapterState.Connected : tronwallet_abstract_adapter_1.AdapterState.Disconnect;
			                this.setAddress(address);
			                this.setState(state);
			                this.emit('connect', this.address || '');
			            }
			    ...
			    _checkWallet() {
			        ...
			        if ((0, tronwallet_abstract_adapter_1.isInBrowser)() && !(0, tronwallet_abstract_adapter_1.isInMobileBrowser)()) {
			            this._checkPromise = new Promise((resolve) => {
			                const timer = setTimeout(() => {
			                    window.removeEventListener(tronwallet_abstract_adapter_2.TIP6963AnnounceProviderEventName, handler);
			                    this._updateWallet();
			                    if ((0, utils_js_1.supportTokenPocket)()) {
			                        this._readyState = tronwallet_abstract_adapter_1.WalletReadyState.Found;
			                        resolve(true);
			                ...
			                const handler = (event) => {
			                    ...
			                    if (info.name === 'TokenPocket') {
			                        this._wallet = {
			                            ready: !!((_b = (_a = provider.tronWeb) === null || _a === void 0 ? void 0 : _a.defaultAddress) === null || _b === void 0 ? void 0 : _b.base58),
			                            tron: provider,
			                ...
			                window.addEventListener(tronwallet_abstract_adapter_2.TIP6963AnnounceProviderEventName, handler);
			                window.dispatchEvent(new Event(tronwallet_abstract_adapter_2.TIP6963RequestProviderEventName));
			            });
			            return this._checkPromise;
			        }
