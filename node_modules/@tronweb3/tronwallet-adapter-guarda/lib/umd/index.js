(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@tronweb3/tronwallet-adapter-guarda"] = factory());
	...
	function requireUtils () {
		...
		utils.supportGuarda = supportGuarda;
		const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
		function supportGuarda() {
		    return (0, tronwallet_abstract_adapter_1.isInBrowser)() && typeof window.guarda !== 'undefined';
		}
	...
	function requireAdapter () {
		...
		(function (exports) {
			...
			Object.defineProperty(exports, "__esModule", { value: true });
			exports.GuardaAdapter = exports.GuardaAdapterName = void 0;
			const tronwallet_abstract_adapter_1 = /*@__PURE__*/ requireCjs$2();
			const tronwallet_adapter_tronlink_1 = /*@__PURE__*/ requireCjs$1();
			const utils_js_1 = /*@__PURE__*/ requireUtils();
			exports.GuardaAdapterName = 'Guarda';
			class GuardaAdapter extends tronwallet_abstract_adapter_1.Adapter {
			    constructor(config = {}) {
			        super();
			        this.name = exports.GuardaAdapterName;
			        ...
			        this._updateWallet = () => {
			            ...
			            if ((0, utils_js_1.supportGuarda)() && guarda) {
			                this._wallet = guarda;
			                this.setState(tronwallet_abstract_adapter_1.AdapterState.Disconnect);
			            }
			            else {
			        ...
			        return __awaiter(this, void 0, void 0, function* () {
			            try {
			                ...
			                if (!wallet || !wallet.tronWeb)
			                    throw new tronwallet_abstract_adapter_1.WalletDisconnectedError();
			                try {
			                    const networkInfo = yield (0, tronwallet_adapter_tronlink_1.getNetworkInfoByTronWeb)(wallet.tronWeb);
			                    return networkInfo;
			                }
			                catch (err) {
			                    throw new tronwallet_abstract_adapter_1.WalletGetNetworkError(err === null || err === void 0 ? void 0 : err.message, err);
			                }
			            }
			            catch (error) {
			                this.emit('error', error);
			        ...
			        return __awaiter(this, void 0, void 0, function* () {
			            try {
			                ...
			                try {
			                    ...
			                    if (error instanceof tronwallet_abstract_adapter_1.WalletError) {
			                        throw error;
			                    }
			                    else {
			                        throw new tronwallet_abstract_adapter_1.WalletConnectionError(error === null || error === void 0 ? void 0 : error.message, error);
			    ...
			    _checkWallet() {
			        ...
			        this._checkPromise = new Promise((resolve) => {
			            const check = () => {
			                times++;
			                const isSupport = (0, utils_js_1.supportGuarda)();
			                if (isSupport || times > maxTimes) {
			                    timer && clearInterval(timer);
			                    this._readyState = isSupport ? tronwallet_abstract_adapter_1.WalletReadyState.Found : tronwallet_abstract_adapter_1.WalletReadyState.NotFound;
			                    this._updateWallet();
			...
			exports.GuardaAdapter = GuardaAdapter;
