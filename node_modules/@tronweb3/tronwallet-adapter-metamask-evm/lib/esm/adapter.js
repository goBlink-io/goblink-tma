...
import { Adapter, WalletReadyState, WalletNotFoundError, WalletConnectionError, isInMobileBrowser, WalletDisconnectedError, } from '@tronweb3/abstract-adapter-evm';
import { getMetaMaskProvider, isMetaMaskMobileWebView, openMetaMaskWithDeeplink } from './utils.js';
export const MetaMaskEvmAdapterName = 'MetaMask';
export class MetaMaskEvmAdapter extends Adapter {
    constructor(options = { useDeeplink: true }) {
        super();
        this.name = MetaMaskEvmAdapterName;
        // @prettier-ignore
