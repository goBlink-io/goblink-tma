...
exports.MetaMaskEvmAdapter = exports.MetaMaskEvmAdapterName = void 0;
const abstract_adapter_evm_1 = require("@tronweb3/abstract-adapter-evm");
const utils_js_1 = require("./utils.js");
exports.MetaMaskEvmAdapterName = 'MetaMask';
class MetaMaskEvmAdapter extends abstract_adapter_evm_1.Adapter {
    constructor(options = { useDeeplink: true }) {
        super();
        this.name = exports.MetaMaskEvmAdapterName;
        // @prettier-ignore
        ...
        const provider = (0, utils_js_1.getMetaMaskProvider)();
        if (provider) {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.options.useDeeplink !== false) {
                if ((0, abstract_adapter_evm_1.isInMobileBrowser)() && !(0, utils_js_1.isMetaMaskMobileWebView)()) {
                    (0, utils_js_1.openMetaMaskWithDeeplink)();
                    return '';
                }
            }
    ...
    signTypedData(_a) {
        return __awaiter(this, arguments, void 0, function* ({ typedData, address = this.address, }) {
            const provider = yield this.prepareProvider();
            if (!this.connected) {
                throw new abstract_adapter_evm_1.WalletDisconnectedError();
            }
...
exports.MetaMaskEvmAdapter = MetaMaskEvmAdapter;
