(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["@tronweb3/tronwallet-adapter-foxwallet"] = factory());
	...
	utils.supportFoxWallet = supportFoxWallet;
	utils.openFoxWallet = openFoxWallet;
	const tronwallet_abstract_adapter_1 = cjs$1;
	function supportFoxWallet() {
	    return (!!tronwallet_abstract_adapter_1.isInMobileBrowser && !!(window.foxwallet && window.foxwallet.tronLink && window.foxwallet.tronLink.tronWeb));
	}
	function openFoxWallet() {
	    if ((0, tronwallet_abstract_adapter_1.isInMobileBrowser)() && !supportFoxWallet()) {
	        const { origin, pathname, search, hash } = window.location;
	...
	(function (exports) {
		...
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.FoxWalletAdapter = exports.FoxWalletAdapterName = void 0;
		const tronwallet_abstract_adapter_1 = cjs$1;
		const tronwallet_adapter_tronlink_1 = cjs;
		const utils_js_1 = utils;
		exports.FoxWalletAdapterName = 'FoxWallet';
		class FoxWalletAdapter extends tronwallet_abstract_adapter_1.Adapter {
		    constructor(config = {}) {
		        super();
		        this.name = exports.FoxWalletAdapterName;
		        ...
		        this._updateWallet = () => {
		            ...
		            let state = this.state;
		            let address = this.address;
		            if ((0, utils_js_1.supportFoxWallet)()) {
		        ...
		        return __awaiter(this, void 0, void 0, function* () {
		            ...
		            try {
		                ...
		                try {
		                    ...
		                    if (res.code === 4000) {
		                        throw new tronwallet_abstract_adapter_1.WalletConnectionError('The same DApp has already initiated a request to connect to FoxWallet, and the pop-up window has not been closed.');
		                    }
		                    if (res.code === 4001) {
		                        throw new tronwallet_abstract_adapter_1.WalletConnectionError('The user rejected connection.');
		                    }
		    ...
		    _checkWallet() {
		        ...
		        this._checkPromise = new Promise((resolve) => {
		            const check = () => {
		                times++;
		                const isSupport = (0, utils_js_1.supportFoxWallet)();
		                if (isSupport || times > maxTimes) {
		                    timer && clearInterval(timer);
		                    this._readyState = isSupport ? tronwallet_abstract_adapter_1.WalletReadyState.Found : tronwallet_abstract_adapter_1.WalletReadyState.NotFound;
		                    this._updateWallet();
		...
		exports.FoxWalletAdapter = FoxWalletAdapter;
