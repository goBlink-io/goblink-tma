...
import { actionCreators, AccessKey, AccessKeyPermission, FullAccessPermission, FunctionCallPermission } from '@near-js/transactions';
...
var $String$5 = globalThis$r.String;
...
var isSymbol$3 = USE_SYMBOL_AS_UID$1 ? function (it) {
  ...
  return isCallable$i($Symbol) && isPrototypeOf$5($Symbol.prototype, $Object$3(it));
};
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$f(val = call$h(fn, input))) return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$f(val = call$h(fn, input))) return val;
  if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$f(val = call$h(fn, input))) return val;
...
var defineGlobalProperty$3 = function (key, value) {
  try {
    defineProperty$6(globalThis$q, key, { value: value, configurable: true, writable: true });
  } catch (error) {
...
var ie8DomDefine = !DESCRIPTORS$e && !fails$n(function () {
  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$d ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$b(O, P)) return createPropertyDescriptor$3(!call$f(propertyIsEnumerableModule$1.f, O, P), O[P]);
};
...
var CONFIGURABLE_LENGTH = DESCRIPTORS$8 && !fails$l(function () {
...
var isForced$2 = function (feature, detection) {
  ...
  return value === POLYFILL ? true
    : value === NATIVE ? false
    : isCallable$b(detection) ? fails$k(detection)
    : !!detection;
};
...
var environment = (function () {
  ...
  if (classof$a(globalThis$j.process) === 'process') return 'NODE';
...
var speciesConstructor$1 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || isNullOrUndefined$1(S = anObject$9(C)[SPECIES$2]) ? defaultConstructor : aConstructor$1(S);
};
...
if (!set$1 || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$8(globalThis$i.postMessage) &&
...
var safeGetBuiltIn$1 = function (name) {
  if (!DESCRIPTORS$6) return globalThis$h[name];
...
if (!microtask$1) {
  ...
  // - setTimeout
    ...
    macrotask = bind$4(macrotask, globalThis$g);
    notify$1 = function () {
      macrotask(flush);
    };
  }
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$7(globalThis$e.PromiseRejectionEvent);
...
var onUnhandled = function (state) {
  call$d(task, globalThis$d, function () {
...
var getIterator$2 = function (argument, usingIterator) {
  ...
  if (aCallable$5(iteratorMethod)) return anObject$8(call$c(iteratorMethod, argument));
  throw new $TypeError$5(tryToString$3(argument) + ' is not iterable');
};
...
var iterate$2 = function (iterable, unboundFunction, options) {
  ...
  if (IS_RECORD) {
    ...
    if (!iterFn) throw new $TypeError$4(tryToString$2(iterable) + ' is not iterable');
...
class WalletModules {
  ...
  decorateWallet(wallet) {
    ...
    wallet.signIn = params => __awaiter(this, void 0, void 0, function* () {
      const accounts = yield _signIn(Object.assign(Object.assign({}, this.options.createAccessKeyFor), params));
      const {
        contractId,
        methodNames = []
      } = params;
    ...
    wallet.createSignedTransaction = (receiverId, actions) => __awaiter(this, void 0, void 0, function* () {
      if (_createSignedTransaction === undefined) {
        throw Error(`The createSignedTransaction method is not supported by ${wallet.metadata.name}`);
      }
      return yield _createSignedTransaction(receiverId, actions);
    });
    // hardware wallets have its own implementation of getPublicKey
    // which will be removed in the next major release
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    wallet.getPublicKey = derivationPath => __awaiter(this, void 0, void 0, function* () {
      if (_getPublicKey === undefined) {
        throw Error(`The getPublicKey method is not supported by ${wallet.metadata.name}`);
      }
      if (typeof derivationPath === "undefined") {
        return yield _getPublicKey();
      } else {
        return yield _getPublicKey(derivationPath);
      }
    });
    wallet.signNep413Message = (...args) => __awaiter(this, void 0, void 0, function* () {
      if (_signNep413Message === undefined) {
        throw Error(`The signNep413Message method is not supported by ${wallet.metadata.name}`);
      }
      return yield _signNep413Message(...args);
    });
    wallet.signTransaction = (...args) => __awaiter(this, void 0, void 0, function* () {
      if (_signTransaction === undefined) {
        throw Error(`The signTransaction method is not supported by ${wallet.metadata.name}`);
      }
      return yield _signTransaction(...args);
    });
    wallet.signDelegateAction = (...args) => __awaiter(this, void 0, void 0, function* () {
      if (_signDelegateAction === undefined) {
        throw Error(`The signDelegateAction method is not supported by ${wallet.metadata.name}`);
      }
      return yield _signDelegateAction(...args);
    });
    return wallet;
  }
  setupInstance(module) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      instance = this.decorateWallet(wallet);
  ...
  setupWalletModules() {
    return __awaiter(this, void 0, void 0, function* () {
      const modules = yield Promise.all(this.factories.map((factory, i) => factory({
        options: this.options
      }).then(module => this.setupModule(module, i)).catch(err => {
  ...
  setupInstantLinkWallet(moduleState) {
    return __awaiter(this, void 0, void 0, function* () {
      if (moduleState.type !== "instant-link") {
        return;
      }
      const wallet = yield moduleState.wallet();
      ...
      try {
        ...
        logger.error("Failed to sign in to wallet. " + wallet.metadata.name + err);
      }
    });
  }
}
...
const getNetworkPreset = (networkId, fallbackRpcUrls) => {
  switch (networkId) {
    case "mainnet":
      return {
        networkId,
        nodeUrl: (fallbackRpcUrls === null || fallbackRpcUrls === void 0 ? void 0 : fallbackRpcUrls[0]) || "https://free.rpc.fastnear.com",
    ...
    case "testnet":
      return {
        networkId,
        nodeUrl: (fallbackRpcUrls === null || fallbackRpcUrls === void 0 ? void 0 : fallbackRpcUrls[0]) || "https://test.rpc.fastnear.com",
...
const resolveOptions = params => {
  const options = {
    ...
    createAccessKeyFor: params.createAccessKeyFor ? typeof params.createAccessKeyFor === "string" ? {
...
var test = [];
var nativeSort$1 = uncurryThis$6(test.sort);
...
const setupWalletSelector = params => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const network = getNetworkPreset(options.network.networkId, params.fallbackRpcUrls);
  ...
  yield walletModules.setupWalletModules();
  yield walletModules.setupStorage();
...
const najActionToInternal = action => {
  ...
  if (action.addKey) {
    ...
    let permission;
    if ("fullAccess" in accessKey.permission && accessKey.permission.fullAccess) {
      permission = "FullAccess";
    } else if ("functionCall" in accessKey.permission && accessKey.permission.functionCall) {
...
const internalActionToNaj = action => {
  var _a, _b, _c;
  ...
  if (action.type === "FunctionCall") {
    ...
    return actionCreators.functionCall(action.params.methodName, action.params.args, BigInt(action.params.gas), BigInt(action.params.deposit));
  }
  ...
  if (action.type === "AddKey") {
    return actionCreators.addKey(PublicKey.from(action.params.publicKey), new AccessKey({
      nonce: BigInt((_a = action.params.accessKey.nonce) !== null && _a !== void 0 ? _a : 0),
      permission: new AccessKeyPermission(Object.assign({}, action.params.accessKey.permission === "FullAccess" ? {
        fullAccess: new FullAccessPermission()
      } : {
        functionCall: new FunctionCallPermission({
          receiverId: action.params.accessKey.permission.receiverId,
          methodNames: (_b = action.params.accessKey.permission.methodNames) !== null && _b !== void 0 ? _b : [],
          allowance: BigInt((_c = action.params.accessKey.permission.allowance) !== null && _c !== void 0 ? _c : 0)
        })
      }))
    }));
  }
...
var NativeArrayBuffer$1 = globalThis$8[ARRAY_BUFFER$1];
var $ArrayBuffer = NativeArrayBuffer$1;
var ArrayBufferPrototype$1 = $ArrayBuffer && $ArrayBuffer[PROTOTYPE];
var $DataView = globalThis$8[DATA_VIEW];
var DataViewPrototype$1 = $DataView && $DataView[PROTOTYPE];
var ObjectPrototype$1 = Object.prototype;
var Array$1 = globalThis$8.Array;
var RangeError$3 = globalThis$8.RangeError;
...
$$2({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$4 }, {
...
var nativeArrayBufferSlice = uncurryThis$3(ArrayBuffer$3.prototype.slice);
...
var Int8Array$4 = globalThis$6.Int8Array;
var Int8ArrayPrototype$1 = Int8Array$4 && Int8Array$4.prototype;
var Uint8ClampedArray$1 = globalThis$6.Uint8ClampedArray;
...
var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$4(globalThis$6.opera) !== 'Opera';
...
var exportTypedArrayMethod$4 = function (KEY, property, forced, options) {
  ...
  if (forced) for (var ARRAY in TypedArrayConstructorsList) {
    var TypedArrayConstructor = globalThis$6[ARRAY];
...
var exportTypedArrayStaticMethod$1 = function (KEY, property, forced) {
  ...
  if (setPrototypeOf$1) {
    if (forced) for (ARRAY in TypedArrayConstructorsList) {
      TypedArrayConstructor = globalThis$6[ARRAY];
...
if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable(TypedArray$1) || TypedArray$1 === Function.prototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
    if (globalThis$6[NAME]) setPrototypeOf$1(globalThis$6[NAME], TypedArray$1);
  }
}
...
if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$1 || TypedArrayPrototype$1 === ObjectPrototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
    if (globalThis$6[NAME]) setPrototypeOf$1(globalThis$6[NAME].prototype, TypedArrayPrototype$1);
  }
}
...
if (DESCRIPTORS$1 && !hasOwn$1(TypedArrayPrototype$1, TO_STRING_TAG)) {
  ...
  defineBuiltInAccessor$1(TypedArrayPrototype$1, TO_STRING_TAG, {
    configurable: true,
    get: function () {
      return isObject$3(this) ? this[TYPED_ARRAY_TAG$1] : undefined;
    }
  });
  for (NAME in TypedArrayConstructorsList) if (globalThis$6[NAME]) {
    createNonEnumerableProperty$1(globalThis$6[NAME], TYPED_ARRAY_TAG$1, NAME);
  }
}
...
var ArrayBuffer$2 = globalThis$5.ArrayBuffer;
var Int8Array$3 = globalThis$5.Int8Array;
...
var RangeError$2 = globalThis$4.RangeError;
...
if (DESCRIPTORS) {
  ...
  typedArrayConstructor.exports = function (TYPE, wrapper, CLAMPED) {
    ...
    var GETTER = 'get' + TYPE;
    var SETTER = 'set' + TYPE;
    var NativeTypedArrayConstructor = globalThis$4[CONSTRUCTOR_NAME];
...
var Int8Array$2 = globalThis$3.Int8Array;
...
var Uint16Array = globalThis$2.Uint16Array;
...
var Int8Array$1 = globalThis$1.Int8Array;
...
var modal$b = {
	wallet: {
		...
		connectionNotSuccessful: "The connection was not successful, please try again.",
		whatIsAWalletDescription: "Wallets let you store digital assets like crypto, and log into apps on NEAR.",
		selectWalletOr: "Please select a wallet on the left, or",
	...
	qr: {
		...
		scanQRCodeMessage: "Please scan this QR code\n to connect your wallet.",
		copyToClipboard: " Copy to clipboard",
		preferTheOfficial: "Prefer the official dialogue of",
		openInOfficialDialogue: "open in official dialogue",
		open: "Open"
	},
	walletTypes: {
...
var modal$a = {
	wallet: {
		...
		connectionNotSuccessful: "La conexión no fue exitosa, por favor intente nuevamente.",
		whatIsAWalletDescription: "Las billeteras te permiten almacenar activos digitales como cripto, e iniciar sesión en aplicaciones de NEAR.",
		selectWalletOr: "Por favor selecciona una billetera a la izquierda, o",
		createNewWallet: "Crear una nueva billetera",
	...
	qr: {
		...
		scanQRCodeMessage: "Por favor escanea este código QR\n para conectar tu billetera.",
		copyToClipboard: " Copiar al Portapapeles",
		preferTheOfficial: "¿Prefires el diálogo oficial de",
		openInOfficialDialogue: "abrir en diálogo oficial",
		open: "Abrir"
	},
	walletTypes: {
...
var modal$9 = {
	wallet: {
		...
		connectionNotSuccessful: "连接未成功，请重试。",
		whatIsAWalletDescription: "钱包让您存储加密等数字资产，并登录 NEAR 应用。",
		selectWalletOr: "请在左侧选择一个钱包，或",
		...
		connectingMessage: {
			injected: "在扩展窗口中确认连接",
			browser: "重定向后在钱包中确认连接",
			hardware: "在 Ledger 设备上确认连接",
			bridge: "在钱包中确认连接"
		}
	},
	ledger: {
	...
	qr: {
		...
		scanQRCodeMessage: "请扫描此二维码\n 以连接你的钱包。",
		copyToClipboard: " 复制到剪贴板",
		preferTheOfficial: "希望使用官方对话框于",
		openInOfficialDialogue: "在官方对话框中打开",
		open: "打开"
	},
	walletTypes: {
		hardware: "硬件钱包",
...
var modal$8 = {
	wallet: {
		...
		connectionNotSuccessful: "Свързването не бе успешно, моля опитайте отново.",
		whatIsAWalletDescription: "Портфейлите ви позволяват да съхранявате дигитални активи като крипто и да се влизате в приложения на NEAR.",
		selectWalletOr: "Моля, изберете портфейл отляво, или",
		createNewWallet: "Създайте нов портфейл",
	...
	qr: {
		...
		scanQRCodeMessage: "Моля сканирайте този QR код\n за да свържете портфейла си.",
		copyToClipboard: " Копирайте в клипборда",
		preferTheOfficial: "Предпочитан език за кореспонденция",
		openInOfficialDialogue: "отворете в официален диалог",
		open: "Отворете"
	},
	walletTypes: {
...
var modal$7 = {
	wallet: {
		...
		connectionNotSuccessful: "연결이 성공하지 못했습니다. 다시 시도해 주세요.",
		whatIsAWalletDescription: "지갑을 사용하면 암호화폐와 같은 디지털 자산을 저장하고 NEAR 앱에 로그인할 수 있습니다.",
		selectWalletOr: "왼쪽에서 지갑을 선택하거나",
	...
	qr: {
		...
		scanQRCodeMessage: "지갑을 연결하려면 이 QR 코드를 스캔하세요.\n",
		copyToClipboard: " 클립보드에 복사하기",
		preferTheOfficial: "다음 프로그램에서 제공하는 공식 프로세스를 선호하십니까: ",
		openInOfficialDialogue: "공식 대화 상자에서 열기",
		open: "Open"
	}
};
var general$7 = {
...
var modal$6 = {
	wallet: {
		...
		connectionNotSuccessful: "Kết nối không thành công, vui lòng thử lại.",
		whatIsAWalletDescription: "Ví cho phép bạn lưu trữ tài sản số như tiền điện tử và đăng nhập vào các ứng dụng trên NEAR.",
		selectWalletOr: "Vui lòng chọn một ví ở bên trái, hoặc",
	...
	qr: {
		...
		scanQRCodeMessage: "Vui lòng quét mã QR này\n để kết nối ví của bạn.",
		copyToClipboard: " Sao chép vào bảng ghi tạm",
		preferTheOfficial: "Dialogue chính thức của",
		openInOfficialDialogue: "mở trong hộp thoại chính thức",
		open: "Mở"
	},
	walletTypes: {
		hardware: "Ví lạnh",
...
var modal$5 = {
	wallet: {
		...
		connectionNotSuccessful: "कनेक्शन सफल नहीं हुआ, कृपया पुनः प्रयास करें।",
		whatIsAWalletDescription: "वॉलेट आपको क्रिप्टो जैसी डिजिटल संपत्तियां स्टोर करने और NEAR पर ऐप्स में लॉग इन करने की अनुमति देता है।",
		selectWalletOr: "कृपया बाईं ओर एक वॉलेट चुनें, या",
		createNewWallet: "एक नया वॉलेट बनाएं",
	...
	qr: {
		...
		scanQRCodeMessage: "कृपया अपने वॉलेट को कनेक्ट करने के लिए इस QR कोड को स्कैन करें।\n",
		copyToClipboard: " क्लिपबोर्ड पर कॉपी करें|",
		preferTheOfficial: "आधिकारिक संवाद को प्राथमिकता दें|",
		openInOfficialDialogue: "आधिकारिक संवाद में खोलें",
		open: "खोले|"
	},
	walletTypes: {
...
var modal$4 = {
	wallet: {
		...
		connectionNotSuccessful: "فشل الاتصال، يرجى المحاولة مرة أخرى.",
		whatIsAWalletDescription: "تتيح لك المحافظ تخزين الأصول الرقمية مثل العملات المشفرة وتسجيل الدخول إلى التطبيقات على NEAR.",
		selectWalletOr: "يرجى اختيار محفظة من اليسار، أو",
	...
	qr: {
		...
		scanQRCodeMessage: "يرجى مسح رمز QR هذا\n لربط محفظتك.",
		copyToClipboard: "نسخ",
		preferTheOfficial: "تفضل الحوار الرسمي ل",
		openInOfficialDialogue: "فتح في الحوار الرسمي",
		open: "فتح"
	},
	walletTypes: {
...
var modal$3 = {
	wallet: {
		...
		connectionNotSuccessful: "Povezivanje nije uspjelo, molimo pokušajte ponovo.",
		whatIsAWalletDescription: "Novčanici vam omogućavaju pohranu digitalne imovine poput kripto valuta i prijavu u aplikacije na NEAR.",
		selectWalletOr: "Molimo odaberite novčanik s lijeve strane ili",
		createNewWallet: "Stvorite novi novčanik",
	...
	qr: {
		...
		scanQRCodeMessage: "Molimo skenirajte ovaj QR kod\n za povezivanje vašeg novčanika.",
		copyToClipboard: " Kopirajte u međuspremnik",
		preferTheOfficial: "Odaberite službeni dijalog",
		openInOfficialDialogue: "otvorite u službenom dijalogu",
		open: "Otvorite"
	},
	walletTypes: {
		hardware: "Hardware Wallet",
...
var modal$2 = {
	wallet: {
		...
		connectionNotSuccessful: "Поврзувањето не беше успешно, ве молиме обидете се повторно.",
		whatIsAWalletDescription: "Новчаниците ви овозможуваат да складирате дигитална имовина како крипто и да се најавите во апликации на NEAR.",
		selectWalletOr: "Ве молиме изберете новчаник лево, или",
		createNewWallet: "Направете нов новчаник",
	...
	qr: {
		...
		scanQRCodeMessage: "Ве молиме скенирајте го овој QR код\n за да се поврзат вашиот новчаник.",
		copyToClipboard: "Копирајте на клипборд",
		preferTheOfficial: "Преферирајте официјален диалог на",
		openInOfficialDialogue: "отворете во официјален дијалог",
		open: "Отворете"
	},
	walletTypes: {
...
var modal$1 = {
	wallet: {
		...
		connectionNotSuccessful: "Povezava ni uspela, prosimo poskusite znova.",
		whatIsAWalletDescription: "Denarnice vam omogočajo shranjevanje digitalnih sredstev, kot so kriptovalute, in prijavo v aplikacije na NEAR.",
		selectWalletOr: "Prosimo izberite denarnico na levi strani ali",
		createNewWallet: "Ustvarite novo denarnico",
	...
	qr: {
		...
		scanQRCodeMessage: "Prosimo skenirajte to kodo QR\n za povezovanje vaše denarnice.",
		copyToClipboard: " Kopirajte v podložni mapi",
		preferTheOfficial: "Preferirajte uradno pogovorno okno",
		openInOfficialDialogue: "odprite v uradnem pogovornem oknu",
		open: "Odprite"
	},
	walletTypes: {
...
var modal = {
	wallet: {
		...
		connectionNotSuccessful: "Веза није успела, молимо покушајте поново.",
		whatIsAWalletDescription: "Новчаници вам омогућавају складиштење дигиталне имовине као што су криптовалуте и пријаву у апликације на NEAR.",
		selectWalletOr: "Молимо изаберите новчаник са леве стране или",
		createNewWallet: "Направите нови новчаник",
	...
	qr: {
		...
		scanQRCodeMessage: "Молимо скенирајте овај QR код\n за повезивање вашег новчаника.",
		copyToClipboard: " Копирај у међуспремник",
		preferTheOfficial: "Преферирате званични дијалог од",
		openInOfficialDialogue: "отвори у званичном дијалогу",
		open: "Отвори"
	},
	walletTypes: {
		hardware: "Хардверски новчаник",
...
export { EventEmitter, allowOnlyLanguage, getActiveAccount, internalActionToNaj, isCurrentBrowserSupported, najActionToInternal, serializeNep413, setupWalletSelector, translate, verifyFullKeyBelongsToUser, verifySignature, waitFor };
