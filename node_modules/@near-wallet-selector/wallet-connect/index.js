...
var toString$3 = uncurryThis$k({}.toString);
...
var $String$5 = globalThis$o.String;
...
var isSymbol$3 = USE_SYMBOL_AS_UID$1 ? function (it) {
  ...
  return isCallable$j($Symbol) && isPrototypeOf$5($Symbol.prototype, $Object$3(it));
};
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$h(fn = input.toString) && !isObject$f(val = call$g(fn, input))) return val;
  if (isCallable$h(fn = input.valueOf) && !isObject$f(val = call$g(fn, input))) return val;
  if (pref !== 'string' && isCallable$h(fn = input.toString) && !isObject$f(val = call$g(fn, input))) return val;
...
$$b({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$4 }, {
...
var environment = (function () {
  ...
  if (classof$a(globalThis$e.process) === 'process') return 'NODE';
...
var bind$6 = uncurryThis$4(uncurryThis$4.bind);
...
if (!set || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$5(globalThis$d.postMessage) &&
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$4(globalThis$9.PromiseRejectionEvent);
...
var isRegexp = function (it) {
  var isRegExp;
  return isObject$4(it) && ((isRegExp = it[MATCH$1]) !== undefined ? !!isRegExp : classof$5(it) === 'RegExp');
};
...
var TO_OBJECT_BUG = WORKS_WITH_OBJECTS_AND_GENERIC_ON_TYPED_ARRAYS && ArrayBufferViewCore$2.NATIVE_ARRAY_BUFFER_VIEWS && fails$3(function () {
...
const setupWalletConnectState = (id, params, emitter) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  let session = null;
  const keystore = new BrowserLocalStorageKeyStore(window.localStorage, `near-wallet-selector:${id}:keystore:`);
  yield client.init({
...
const WalletConnect = ({
  ...
  const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < accounts.length; i++) {
      const publicKey = yield _state.keystore.getKey(options.network.networkId, accounts[i].split(":")[2]);
      newAccounts.push({
  ...
  const signTransactions = transactions => __awaiter(void 0, void 0, void 0, function* () {
    const keyPair = yield _state.keystore.getKey(options.network.networkId, transactions[0].signerId);
    ...
    for (let i = 0; i < transactions.length; i += 1) {
      ...
      const tx = createTransaction(transactions[i].signerId, PublicKey.from(publicKey.toString()), transactions[i].receiverId, accessKey.nonce + i + 1, transaction.actions, baseDecode(block.header.hash));
  ...
  const requestSignTransaction = transaction => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tx = createTransaction(transaction.signerId, PublicKey.from(account.publicKey), transaction.receiverId, accessKey.nonce + 1, transaction.actions, baseDecode(block.header.hash));
  ...
  const requestSignTransactions = transactions => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < transactions.length; i += 1) {
      ...
      txs.push(createTransaction(transaction.signerId, PublicKey.from(account.publicKey), transaction.receiverId, accessKey.nonce + i + 1, transaction.actions, baseDecode(block.header.hash)));
    }
  ...
  return {
    ...
    createSignedTransaction(receiverId, actions) {
      return __awaiter(this, void 0, void 0, function* () {
        logger.log("createSignedTransaction", {
          receiverId,
          actions
        });
    ...
    signNep413Message(message, accountId, recipient, nonce, callbackUrl) {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    signDelegateAction(delegateAction) {
      return __awaiter(this, void 0, void 0, function* () {
