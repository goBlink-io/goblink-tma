...
var providers = require('@near-js/providers');
var crypto = require('@near-js/crypto');
...
var toString$2 = uncurryThis$i({}.toString);
...
var defineGlobalProperty$3 = function (key, value) {
  try {
    defineProperty$5(globalThis$r, key, { value: value, configurable: true, writable: true });
  } catch (error) {
...
var toString$1 = uncurryThis$f(1.0.toString);
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$g(fn = input.toString) && !isObject$c(val = call$f(fn, input))) return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$c(val = call$f(fn, input))) return val;
  if (pref !== 'string' && isCallable$g(fn = input.toString) && !isObject$c(val = call$f(fn, input))) return val;
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$8 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$9(O, P)) return createPropertyDescriptor$2(!call$d(propertyIsEnumerableModule.f, O, P), O[P]);
};
...
var getInternalArrayBufferState = InternalStateModule$3.getterFor(ARRAY_BUFFER$1);
...
$$8({ global: true, constructor: true, forced: NativeArrayBuffer !== ArrayBuffer$4 }, {
...
var nativeArrayBufferSlice = uncurryThis$5(ArrayBuffer$3.prototype.slice);
var getUint8 = uncurryThis$5(DataViewPrototype.getUint8);
var setUint8 = uncurryThis$5(DataViewPrototype.setUint8);

var INCORRECT_SLICE = fails$8(function () {
...
var environment = (function () {
  ...
  if (classof$9(globalThis$e.process) === 'process') return 'NODE';
...
var aConstructor$2 = function (argument) {
  ...
  throw new $TypeError$5(tryToString$3(argument) + ' is not a constructor');
};
...
if (!set || !clear) {
  ...
  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
    ...
    isCallable$4(globalThis$d.postMessage) &&
...
var safeGetBuiltIn$1 = function (name) {
  if (!DESCRIPTORS$2) return globalThis$c[name];
  var descriptor = getOwnPropertyDescriptor(globalThis$c, name);
...
if (!microtask$1) {
  ...
  // - setTimeout
    ...
    macrotask = bind$4(macrotask, globalThis$b);
    notify$1 = function () {
      macrotask(flush);
    };
  }
...
var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$3(globalThis$9.PromiseRejectionEvent);
...
var onUnhandled = function (state) {
  call$a(task, globalThis$8, function () {
...
var getIterator$2 = function (argument, usingIterator) {
  ...
  if (aCallable$3(iteratorMethod)) return anObject$5(call$9(iteratorMethod, argument));
...
var Int8Array$4 = globalThis$7.Int8Array;
var Int8ArrayPrototype$1 = Int8Array$4 && Int8Array$4.prototype;
var Uint8ClampedArray$1 = globalThis$7.Uint8ClampedArray;
...
var NATIVE_ARRAY_BUFFER_VIEWS$2 = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$4(globalThis$7.opera) !== 'Opera';
...
var exportTypedArrayStaticMethod = function (KEY, property, forced) {
  ...
  if (setPrototypeOf$1) {
    if (forced) for (ARRAY in TypedArrayConstructorsList) {
      TypedArrayConstructor = globalThis$7[ARRAY];
...
if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !isCallable(TypedArray$1) || TypedArray$1 === Function.prototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
    if (globalThis$7[NAME]) setPrototypeOf$1(globalThis$7[NAME], TypedArray$1);
  }
}
...
if (!NATIVE_ARRAY_BUFFER_VIEWS$2 || !TypedArrayPrototype$1 || TypedArrayPrototype$1 === ObjectPrototype) {
  ...
  if (NATIVE_ARRAY_BUFFER_VIEWS$2) for (NAME in TypedArrayConstructorsList) {
    if (globalThis$7[NAME]) setPrototypeOf$1(globalThis$7[NAME].prototype, TypedArrayPrototype$1);
  }
}
...
if (DESCRIPTORS$1 && !hasOwn$1(TypedArrayPrototype$1, TO_STRING_TAG)) {
  ...
  for (NAME in TypedArrayConstructorsList) if (globalThis$7[NAME]) {
    createNonEnumerableProperty$2(globalThis$7[NAME], TYPED_ARRAY_TAG$1, NAME);
  }
}
...
var Int8Array$3 = globalThis$6.Int8Array;
...
var RangeError$2 = globalThis$5.RangeError;
...
if (DESCRIPTORS) {
  ...
  typedArrayConstructor.exports = function (TYPE, wrapper, CLAMPED) {
    ...
    var GETTER = 'get' + TYPE;
    var SETTER = 'set' + TYPE;
    var NativeTypedArrayConstructor = globalThis$5[CONSTRUCTOR_NAME];
...
var toIndexedObject = toObject$5;
var fails$2 = fails$k;
...
function legacySignTransaction(transaction, signer, accountId, networkId) {
  return __awaiter(this, void 0, void 0, function* () {
    const message = transactions.encodeTransaction(transaction);
    ...
    const keyType = transaction.publicKey.ed25519Key ? crypto.KeyType.ED25519 : crypto.KeyType.SECP256K1;
...
const signTransactions = (transactions$1, signer, network) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  for (let i = 0; i < transactions$1.length; i++) {
    ...
    const transaction = transactions.createTransaction(transactions$1[i].signerId, crypto.PublicKey.from(publicKey.toString()), transactions$1[i].receiverId, accessKey.nonce + i + 1, transactions$1[i].actions, utils.baseDecode(block.header.hash));
    const [, signedTx] = "signTransaction" in signer && signer.signTransaction ? yield signer.signTransaction(transaction) : yield legacySignTransaction(transaction, signer, transactions$1[i].signerId, network.networkId);
    const finalSignedTx = new transactions.SignedTransaction({
      signature: new transactions.Signature({
        data: Buffer.from(signedTx.signature.data),
        keyType: publicKey.keyType === crypto.KeyType.SECP256K1 ? crypto.KeyType.SECP256K1 : crypto.KeyType.ED25519
      }),
...
exports.LegacySigner = LegacySigner;
