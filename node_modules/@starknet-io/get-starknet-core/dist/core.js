...
var O = (t, e, r) => (re(t, typeof e != "symbol" ? e + "" : e, r), r), Z = (t, e, r) => {
  if (!e.has(t))
    throw TypeError("Cannot " + r);
};
var v = (t, e, r) => (Z(t, e, "read from private field"), r ? r.call(t) : e.get(t)), L = (t, e, r) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, r);
}, G = (t, e, r, n) => (Z(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
...
function satisfy(t, e) {
  ...
  for (const h of o) {
    ...
    const [, y, , m, g, M, A] = p, I = {
      operator: y,
      version: combineVersion(m, g, M, A),
      major: m,
      minor: g,
      patch: M,
...
function generateSnapshotFromManifest(t) {
  ...
  if (!Object.keys(i).length) {
    var p;
    h = ((p = t.remotes) === null || p === void 0 ? void 0 : p.reduce(function(b, B) {
      var Q, V = B.federationContainerName;
      return u.includes(V) ? Q = a[V] : "version" in B ? Q = B.version : Q = B.entry, b[V] = {
        matchedVersion: Q
      }, b;
    }, {})) || {};
  }
  Object.keys(i).forEach(function(b) {
    return h[b] = {
      matchedVersion: u.includes(b) ? a[b] : i[b]
    };
  });
  var y = t.metaData, m = y.remoteEntry, g = m.path, M = m.name, A = m.type, I = y.types, D = y.buildInfo.buildVersion, E = y.globalName, N = t.exposes, z = {
    version: c || "",
    buildVersion: D,
    globalName: E,
    remoteEntry: simpleJoinRemoteEntry(g, M),
    remoteEntryType: A,
    remoteTypes: simpleJoinRemoteEntry(I.path, I.name),
    remoteTypesZip: I.zip || "",
    remoteTypesAPI: I.api || "",
    remotesInfo: h,
    ...
    modules: N == null ? void 0 : N.map(function(b) {
      return {
        moduleName: b.name,
        modulePath: b.path,
        assets: b.assets
  ...
  if (!((r = t.metaData) === null || r === void 0) && r.prefetchInterface) {
    ...
    z = _object_spread_props(_object_spread$2({}, z), {
      prefetchInterface: x
    });
  }
  if (!((n = t.metaData) === null || n === void 0) && n.prefetchEntry) {
    var j = t.metaData.prefetchEntry, w = j.path, S = j.name, U = j.type;
    z = _object_spread_props(_object_spread$2({}, z), {
      prefetchEntry: simpleJoinRemoteEntry(w, S),
      prefetchEntryType: U
    });
  }
  return "publicPath" in t.metaData ? l = _object_spread_props(_object_spread$2({}, z), {
    publicPath: d()
  }) : l = _object_spread_props(_object_spread$2({}, z), {
    getPublicPath: d()
  }), l;
}
...
function createScript(t) {
  ...
  var u = function(h, p) {
    ...
    if (clearTimeout(o), e && (e.onerror = null, e.onload = null, safeWrapper(function() {
      var M = t.needDeleteScript, A = M === void 0 ? !0 : M;
      A && e != null && e.parentNode && e.parentNode.removeChild(e);
    }), h)) {
      var m, g = h(p);
      return t == null || (m = t.cb) === null || m === void 0 || m.call(t), g;
    }
...
function createLink(t) {
  ...
  var d = function(u, h) {
    if (e && (e.onerror = null, e.onload = null, safeWrapper(function() {
      var y = t.needDeleteLink, m = y === void 0 ? !0 : y;
...
let Module = class {
 ...
 ${safeToString$1(this.remoteInfo)}`), this.remoteEntryExports = e, this.remoteEntryExports;
  ...
  async get(e, r, n) {
    ...
    const a = this.wraperFactory(s, e);
    return o ? await a() : a;
  }
  wraperFactory(e, r) {
    function n(o, i) {
...
function preloadAssets(t, e, r, n = !0) {
  const { cssAssets: o, jsAssetsWithoutEntry: i, entryAssets: s } = r;
  e.options.inBrowser && (s.forEach((a) => {
  ...
  return {
    ...
    async afterResolve(t) {
      ...
      if (!isRemoteInfoWithEntry(e) || !isPureRemoteEntry(e)) {
        ...
        return l && preloadAssets(i, o, l, !1), _extends$4({}, t, {
          remoteSnapshot: s
        });
      }
      return t;
...
function generatePreloadAssets(t, e, r, n, o) {
  const i = [], s = [], a = [], c = /* @__PURE__ */ new Set(), l = /* @__PURE__ */ new Set(), { options: d } = t, { preloadConfig: u } = e, { depsRemote: h } = u;
  if (traverseModuleInfo(n, r, (g, M, A) => {
    let I;
    if (A)
      I = u;
    else if (Array.isArray(h)) {
      const j = h.find((w) => w.nameOrAlias === M.name || w.nameOrAlias === M.alias);
      if (!j)
        return;
      I = defaultPreloadArgs(j);
    } else if (h === !0)
      I = u;
    else
      return;
    const D = getResourceUrl(g, "remoteEntry" in g ? g.remoteEntry : "");
    D && a.push({
      name: M.name,
      moduleInfo: {
        name: M.name,
    ...
    let E = "modules" in g ? g.modules : [];
    const N = normalizePreloadExposes(I.exposes);
    if (N.length && "modules" in g) {
      var z;
      E = g == null || (z = g.modules) == null ? void 0 : z.reduce((j, w) => ((N == null ? void 0 : N.indexOf(w.moduleName)) !== -1 && j.push(w), j), []);
    }
    function x(j) {
      const w = j.map((S) => getResourceUrl(g, S));
      return I.filter ? w.filter(I.filter) : w;
    }
    if (E) {
      const j = E.length;
      for (let w = 0; w < j; w++) {
        const S = E[w], U = `${M.name}/${S.moduleName}`;
        t.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
          id: S.moduleName === "." ? M.name : U,
          name: M.name,
          remoteSnapshot: g,
          preloadConfig: I,
          remote: M,
          origin: t
        }), !getPreloaded(U) && (I.resourceCategory === "all" ? (i.push(...x(S.assets.css.async)), i.push(...x(S.assets.css.sync)), s.push(...x(S.assets.js.async)), s.push(...x(S.assets.js.sync))) : (I.resourceCategory = "sync") && (i.push(...x(S.assets.css.sync)), s.push(...x(S.assets.js.sync))), setPreloaded(U));
      }
    }
  }, !0, {}, o), o.shared) {
    const g = (M, A) => {
      const I = getRegisteredShare(t.shareScopeMap, A.sharedName, M, t.sharedHandler.hooks.lifecycle.resolveShare);
      I && typeof I.lib == "function" && (A.assets.js.sync.forEach((D) => {
        c.add(D);
      }), A.assets.css.sync.forEach((D) => {
        l.add(D);
      }));
    };
    o.shared.forEach((M) => {
      var A;
      const I = (A = d.shared) == null ? void 0 : A[M.sharedName];
      if (!I)
        return;
      const D = M.version ? I.find((N) => N.version === M.version) : I;
      if (!D)
        return;
      arrayOptions(D).forEach((N) => {
        g(N, M);
      });
    });
  }
  const y = s.filter((g) => !c.has(g));
  return {
    cssAssets: i.filter((g) => !l.has(g)),
    jsAssetsWithoutEntry: y,
    entryAssets: a
  };
}
  ...
  async loadRemoteSnapshotInfo(e) {
    ...
    if (a)
      if (isManifestProvider(a)) {
        const l = await this.getManifestJson(a.remoteEntry, e, {}), d = setGlobalSnapshotInfoByModuleInfo(_extends$3({}, e, {
          entry: a.remoteEntry
        }), l);
        return {
          remoteSnapshot: l,
      ...
      const l = await this.getManifestJson(e.entry, e, {}), d = setGlobalSnapshotInfoByModuleInfo(e, l), { remoteSnapshot: u } = await this.hooks.lifecycle.loadRemoteSnapshot.emit({
        options: this.HostInstance.options,
        moduleInfo: e,
        remoteSnapshot: l,
        from: "global"
...
class SharedHandler {
  registerShared(e, r) {
    ...
    return Object.keys(n).forEach((s) => {
      n[s].forEach((c) => {
        !getRegisteredShare(this.shareScopeMap, s, c, this.hooks.lifecycle.resolveShare) && c && c.lib && this.setShared({
          pkgName: s,
          lib: c.lib,
          get: c.get,
          loaded: !0,
  ...
  async loadShare(e, r) {
    ...
    if (a && a.loading && !a.loaded) {
      ...
      const d = (async () => {
        ...
        const h = getRegisteredShare(this.shareScopeMap, e, s, this.hooks.lifecycle.resolveShare);
  ...
  initializeSharing(e = DEFAULT_SCOPE, r) {
    const { host: n } = this, o = this.shareScopeMap, i = n.options.name;
    o[e] || (o[e] = {});
    const s = o[e], a = (u, h) => {
      var p;
      const { version: y, eager: m } = h;
      s[u] = s[u] || {};
      const g = s[u], M = g[y], A = Boolean(M && (M.eager || ((p = M.shareConfig) == null ? void 0 : p.eager)));
      (!M || M.strategy !== "loaded-first" && !M.loaded && (Boolean(!m) !== !A ? m : i > M.from)) && (g[y] = h);
    }, c = [], l = (u) => u && u.init && u.init(o[e]), d = async (u) => {
      const { module: h } = await n.remoteHandler.getRemoteModuleAndOptions({
        id: u
      });
      if (h.getEntry) {
        const p = await h.getEntry();
        h.inited || (l(p), h.inited = !0);
      }
    };
    return Object.keys(n.options.shared).forEach((u) => {
      n.options.shared[u].forEach((p) => {
        p.scope.includes(e) && a(u, p);
      });
  ...
  loadShareSync(e, r) {
    ...
    if (i) {
      if (typeof i.lib == "function")
        return s(i), i.loaded || (i.loaded = !0, i.from === n.options.name && (o.loaded = !0)), i.lib;
  ...
  setShared({ pkgName: e, shared: r, from: n, lib: o, loading: i, loaded: s, get: a }) {
    const { version: c, scope: l = "default" } = r, d = _object_without_properties_loose(r, [
      "version",
      "scope"
    ]);
    (Array.isArray(l) ? l : [
...
class RemoteHandler {
  ...
  async loadRemote(e, r) {
    ...
    try {
      const { loadFactory: o = !0 } = r || {
        loadFactory: !0
      }, { module: i, moduleOptions: s, remoteMatchInfo: a } = await this.getRemoteModuleAndOptions({
        id: e
      }), { pkgNameOrAlias: c, remote: l, expose: d, id: u } = a, h = await i.get(u, d, r), p = await this.hooks.lifecycle.onLoad.emit({
        id: u,
        pkgNameOrAlias: c,
        expose: d,
  ...
  async preloadRemote(e) {
    ...
    await Promise.all(n.map(async (o) => {
      const { remote: i } = o, s = getRemoteInfo(i), { globalSnapshot: a, remoteSnapshot: c } = await r.snapshotHandler.loadRemoteSnapshotInfo(i), l = await this.hooks.lifecycle.generatePreloadAssets.emit({
        origin: r,
        preloadOptions: o,
        remote: i,
        remoteInfo: s,
  ...
  async getRemoteModuleAndOptions(e) {
    ...
    const { id: i } = o, s = matchRemoteWithNameAndExpose(r.options.remotes, i);
    assert(s, `
      ...
      `);
    const { remote: a } = s, c = getRemoteInfo(a), l = await r.sharedHandler.hooks.lifecycle.afterResolve.emit(_extends$1({
      id: i
    }, s, {
      options: r.options,
      origin: r,
    ...
    assert(d && u, `The 'beforeRequest' hook was executed, but it failed to return the correct 'remote' and 'expose' values while loading ${i}.`);
    let h = r.moduleCache.get(d.name);
    const p = {
      host: r,
      remoteInfo: c
    };
    return h || (h = new Module(p), r.moduleCache.set(d.name, h)), {
      module: h,
      moduleOptions: p,
      remoteMatchInfo: l
    };
  ...
  registerRemote(e, r, n) {
    ...
    if (!s)
      ...
      n != null && n.force && (this.removeRemote(s), i(), r.push(e), this.hooks.lifecycle.registerRemote.emit({
        remote: e,
        origin: o
      })), warn(a.join(" "));
    }
  ...
  removeRemote(e) {
    ...
    if (i) {
      var s;
      const a = i.remoteInfo, c = a.entryGlobalName;
      globalThis[c] && ((s = Object.getOwnPropertyDescriptor(globalThis, c)) == null ? void 0 : s.configurable) && delete globalThis[c];
      const l = getRemoteEntryUniqueKey(i.remoteInfo);
      globalLoading[l] && delete globalLoading[l];
      let d = a.buildVersion ? composeKeyWithSeparator(a.name, a.buildVersion) : a.name;
      const u = globalThis.__FEDERATION__.__INSTANCES__.findIndex((h) => a.buildVersion ? h.options.id === d : h.name === d);
      if (u !== -1) {
        ...
        Object.keys(p).forEach((g) => {
          Object.keys(p[g]).forEach((M) => {
            Object.keys(p[g][M]).forEach((A) => {
              Object.keys(p[g][M][A]).forEach((I) => {
                const D = p[g][M][A][I];
                D.from === a.name && (D.loaded || D.loading ? (D.useIn = D.useIn.filter((E) => E !== a.name), D.useIn.length ? y = !1 : m.push([
                  g,
                  M,
                  A,
                  I
        ...
        }), y && (h.shareScopeMap = {}, delete p[d]), m.forEach(([g, M, A, I]) => {
          var D, E, N;
          (N = p[g]) == null || (E = N[M]) == null || (D = E[A]) == null || delete D[I];
...
class FederationHost {
  ...
  formatOptions(e, r) {
    const { shared: n } = formatShareConfigs(e, r), { userOptions: o, options: i } = this.hooks.lifecycle.beforeInit.emit({
      ...
      options: e,
      shareInfo: n
    }), s = this.remoteHandler.formatAndRegisterRemote(i, o), { shared: a } = this.sharedHandler.registerShared(i, o), c = [
      ...i.plugins
    ];
...
function __awaiter(t, e, r, n) {
  ...
  return new (r || (r = Promise))(function(i, s) {
    ...
    function l(d) {
      d.done ? i(d.value) : o(d.value).then(a, c);
    }
...
var E_CANCELED = new Error("request for lock canceled"), Semaphore = function() {
  ...
  return t.prototype.acquire = function(e, r) {
    ...
    return new Promise(function(o, i) {
      var s = { resolve: o, reject: i, weight: e, priority: r }, a = findIndexFromEnd(n._queue, function(c) {
        return r <= c.priority;
      });
    ...
    return __awaiter(this, arguments, void 0, function(r, n, o) {
      ...
      return n === void 0 && (n = 1), o === void 0 && (o = 0), __generator(this, function(c) {
        switch (c.label) {
          ...
          case 1:
            i = c.sent(), s = i[0], a = i[1], c.label = 2;
          case 2:
            return c.trys.push([2, , 4, 5]), [4, r(s)];
          case 3:
            return [2, c.sent()];
          case 4:
            return a(), [7];
...
Y = new WeakSet(), q = async function(e) {
...
}, R = new WeakSet(), H = async function(e = window) {
  return this.lock.runExclusive(async () => (this.swo || (this.swo = await _(this, Y, q).call(this, e), _(this, F, J).call(this)), this.swo));
}, F = new WeakSet(), J = function() {
...
const wallets = [
  ...
  },
  {
    ...
    downloads: {
      ...
      android: `https://link.braavos.app/dapp/${(K = ssrSafeWindow == null ? void 0 : ssrSafeWindow.location) == null ? void 0 : K.host}`
    }
  },
  {
...
class LocalStorageWrapper {
  constructor(e) {
    ...
    L(this, P, void 0);
    O(this, "value");
    G(this, P, e), _(this, k, W).call(this);
  }
  set(e) {
...
function getStarknet(t = {}) {
  ...
  return initiateVirtualWallets(r), {
    ...
    getLastConnectedWallet: async () => {
      const i = o.get(), a = scanObjectForWallets(r, n).find(
        (l) => l.id === i
    ...
    discoverVirtualWallets: async (i = []) => {
      const s = new Set(i), a = s.size > 0 ? virtualWallets.filter(
        (c) => s.has(c.name) || s.has(c.id)
      ) : virtualWallets;
      await Promise.all(
        a.map(async (c) => {
    ...
    enable: async (i, s) => {
      ...
      await a.request({
        ...
        params: {
          silent_mode: s == null ? void 0 : s.silent_mode
        }
      });
