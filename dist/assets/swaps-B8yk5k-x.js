import{cI as A,cQ as a,cJ as g,cK as P,cL as c}from"./index-BxHmVW6A.js";import{b as E,N as h,j as K,E as W,R as S,A as U,d as M,M as F,g as Q,W as q,r as z,e as H}from"./index-BIQ64_dT.js";import{c as D}from"./index-D4Znke3K.js";import"./index-CUJ7YLLA.js";import"./index-C3uLqky6.js";import{M as j}from"./index-mO-ejkjj.js";import"./index-Dt4tHmeS.js";import{S as n}from"./SwapController-F5wvEzSk.js";import"./index-CxL3Wkrc.js";import"./index-BuEM4xOr.js";import"./index-BaxBz4yO.js";import"./index-1FSGpYd2.js";import"./index.es-CmLrfvcW.js";import"./index-nibyPLVP.js";import"./index-CJ3BYJlU.js";import"./index-By_kGdXh.js";const G={numericInputKeyDown(u,e,t){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=u.metaKey||u.ctrlKey,o=u.key,r=o.toLocaleLowerCase(),l=r==="a",b=r==="c",I=r==="v",_=r==="x",L=o===",",O=o===".",B=o>="0"&&o<="9";!s&&(l||b||I||_)&&u.preventDefault(),e==="0"&&!L&&!O&&o==="0"&&u.preventDefault(),e==="0"&&B&&(t(o),u.preventDefault()),(L||O)&&(e||(t("0."),u.preventDefault()),(e!=null&&e.includes(".")||e!=null&&e.includes(","))&&u.preventDefault()),!B&&!i.includes(o)&&!O&&!L&&u.preventDefault()}},J=A`
  :host {
    width: 100%;
  }
...
`;var v=function(u,e,t,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(u,e,t,i);else for(var l=u.length-1;l>=0;l--)(r=u[l])&&(o=(s<3?r(o):s>3?r(e,t,o):r(e,t))||o);return s>3&&o&&Object.defineProperty(e,t,o),o};const X=K.CONVERT_SLIPPAGE_TOLERANCE;let m=class extends P{constructor(){var e;super(),this.unsubscribe=[],this.networkName=(e=E.state.activeCaipNetwork)==null?void 0:e.name,this.detailsOpen=!1,this.sourceToken=n.state.sourceToken,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.priceImpact=n.state.priceImpact,this.maxSlippage=n.state.maxSlippage,this.networkTokenSymbol=n.state.networkTokenSymbol,this.inputError=n.state.inputError,this.unsubscribe.push(n.subscribe(t=>{this.sourceToken=t.sourceToken,this.toToken=t.toToken,this.toTokenAmount=t.toTokenAmount,this.priceImpact=t.priceImpact,this.maxSlippage=t.maxSlippage,this.sourceTokenPriceInUSD=t.sourceTokenPriceInUSD,this.toTokenPriceInUSD=t.toTokenPriceInUSD,this.inputError=t.inputError}))}render(){const e=this.toTokenAmount&&this.maxSlippage?h.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return c`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};m.styles=[J];v([a()],m.prototype,"networkName",void 0);v([g()],m.prototype,"detailsOpen",void 0);v([a()],m.prototype,"sourceToken",void 0);v([a()],m.prototype,"toToken",void 0);v([a()],m.prototype,"toTokenAmount",void 0);v([a()],m.prototype,"sourceTokenPriceInUSD",void 0);v([a()],m.prototype,"toTokenPriceInUSD",void 0);v([a()],m.prototype,"priceImpact",void 0);v([a()],m.prototype,"maxSlippage",void 0);v([a()],m.prototype,"networkTokenSymbol",void 0);v([a()],m.prototype,"inputError",void 0);m=v([D("w3m-swap-details")],m);const Y=A`
  :host {
    width: 100%;
  }
...
`;var V=function(u,e,t,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(u,e,t,i);else for(var l=u.length-1;l>=0;l--)(r=u[l])&&(o=(s<3?r(o):s>3?r(e,t,o):r(e,t))||o);return s>3&&o&&Object.defineProperty(e,t,o),o};let R=class extends P{constructor(){super(...arguments),this.target="sourceToken"}render(){return c`
    ...
    `}};R.styles=[Y];V([g()],R.prototype,"target",void 0);R=V([D("w3m-swap-input-skeleton")],R);const Z=A`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var T=function(u,e,t,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(u,e,t,i);else for(var l=u.length-1;l>=0;l--)(r=u[l])&&(o=(s<3?r(o):s>3?r(e,t,o):r(e,t))||o);return s>3&&o&&Object.defineProperty(e,t,o),o};const ee=5e-5;let x=class extends P{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return c`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){W.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),S.push("SwapSelectToken",{target:this.target})}onBuyToken(){S.push("OnRampProviders")}};x.styles=[Z];T([g()],x.prototype,"focused",void 0);T([g()],x.prototype,"balance",void 0);T([g()],x.prototype,"value",void 0);T([g()],x.prototype,"price",void 0);T([g()],x.prototype,"marketValue",void 0);T([g()],x.prototype,"disabled",void 0);T([g()],x.prototype,"target",void 0);T([g()],x.prototype,"token",void 0);T([g()],x.prototype,"onSetAmount",void 0);T([g()],x.prototype,"onSetMaxValue",void 0);x=T([D("w3m-swap-input")],x);const te=A`
