import{cI as f,cJ as d,cQ as c,cK as w,cN as O,cO as D,cL as u,cM as F}from"./index-BxHmVW6A.js";import{d as I,b as x,C as H,V as l,r as z,e as W,R as g,N as L,o as M,S as _,E as Y,g as K,W as J}from"./index-BIQ64_dT.js";import{c as m,U as $}from"./index-D4Znke3K.js";import"./index-CUJ7YLLA.js";import"./index-By_kGdXh.js";import"./index-C3uLqky6.js";import{n as Q,s as G}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-zkEPKZCL.js";import"./index-BuEM4xOr.js";import{S as q}from"./SwapController-F5wvEzSk.js";import"./index-BaxBz4yO.js";import"./index-o72NDE_T.js";import"./index-DrzgmiS3.js";import"./index-1FSGpYd2.js";import"./index.es-CmLrfvcW.js";import"./index-nibyPLVP.js";import"./index-CJ3BYJlU.js";import"./index-CxL3Wkrc.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else Q.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(G,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];B([d({type:Boolean})],C.prototype,"disabled",void 0);B([d({type:String})],C.prototype,"value",void 0);B([d({type:String})],C.prototype,"placeholder",void 0);C=B([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
