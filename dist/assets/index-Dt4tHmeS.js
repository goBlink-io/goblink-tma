import{cI as g,cQ as u,cK as m,cL as w}from"./index-BxHmVW6A.js";import{w as f,s as v,m as b,p as x}from"./index-BIQ64_dT.js";import{c as h}from"./index-D4Znke3K.js";import"./index-C3uLqky6.js";const e=x({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return b(e,()=>o(e))},subscribeKey(o,t){return v(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=f(y),R=g`
  :host {
    pointer-events: none;
  }
